...
EEG data contains a variety of signals, elicited by sounds, that can be exploited by a \ac{BCI}. 
...
Machine learning is an emerging field that explores algorithms that can learn from and make predictions on data.
...
In the retina we have cells that are responsive to small regions of the visual field \cite{Hubel1963}. 
...
At each level of this process more information is combined giving cells at each processing layer an increasingly global view of what information was collected by the retinal cells.
...
In this experiment the filters used are \acp{CAE} (as described in \cite{masci2011}).
