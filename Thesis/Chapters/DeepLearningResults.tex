...
To investigate whether the neural net is relying on a process similar to that which humans might employ, we decided to run a follow-up experiment asking participants to rate the similarity of pairs of stimuli. 
