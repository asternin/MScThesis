...
Removing unwanted noise (i.e. from external sources, muscle movements, or eye blinks) allows analyses to be done on data within the frequency range of signals produced by the brain. 
This ensures that the final results can be solely attributed to a brain process and are not confounded by other sources of electrical activity.
