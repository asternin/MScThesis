...
%
\newcommand{\etal}{{\it et al.~}}  %% better {{\it et al}.}, and in use: \etal\ (note the trailing \ , **only when you need** the space after . )
%
%\makeatletter
%
...
%\includeonly{Chapters/Behavioural,Chapters/Discussion}
%
\begin{document}
\include{frontmatter}
\begin{spacing}{2}
