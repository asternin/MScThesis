...
\lhead{\emph{Methods}} 
\input{Chapters/Methods} % Experimental Setup 

%\lhead{\emph{Tempo}}
%\input{Chapters/TempoResults} % Tempo Results

\lhead{\emph{ERP}}
\input{Chapters/ERPResults} % ERPResults

\lhead{\emph{Classification}}
\input{Chapters/Classification} % Classification

%\input{Chapters/Discussion} % Discussion term
